...
token = 'NzkyNjY0MTcxMDAxOTM3OTUx.X-hACQ.RGPU_y_9vMWcqZmF7cU4ZLtEo7Y' #봇토큰
category_id = 792664966192431164 #배너채널 생성되는 카테고리 ID
banner_role = '배너' #배너역할 이름
logchannel_id = 791285847647059968 #개설 로그채널 ID
webhookcnl_id = 778262442706599956 #받아온 웹훅 보내주는 채널ID
...
async def on_message(message):
    ...
    if message.content.startswith('=맞배너'):
        ...
        """ 수정금지
            dev = ライム#0001, id = 684287460414324757
        """
